...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
  <Card
    title="$QUBIC"
    description="Understand the core unit of the Qubic ecosystem. Understand $QUBIC , its role in transactions and how it facilitate value transfer across the network."
